...
extern unsigned short * psxVuw; // the main blit dest
extern signed short   * psxVsw; // doesn't appear to be used 
extern unsigned long  * psxVul;// doesn't appear to be used 
extern signed long    * psxVsl; // doesn't appear to be used 
