...
void psxReset() {
	...
	psxRegs.CP0.r[12] = 0;//0x10900000; // COP0 enabled | BEV = 1 | TS = 1
	psxRegs.CP0.r[15] = 0;//0x00000002; // PRevID = Revision ID, same as R3000A
...
// cycle speed hack X2 removed from ExecI Yoshihiro ^_^ 
psxRegs.cycle++; 
